...
export function setup() {
    ...
    var payload = JSON.stringify({
        "email": "tensanf@gmail.com",
        "password": "bebas123"
    });

    const loginResponse = http.post(`${baseUrl}/v1/login/company-user`, payload, params);
...
export default function (data) {
    ...
    // You can add additional logic here to perform other actions
